    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-black mb-4">Why Choose ModernWear?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Carefully crafted from the finest materials for lasting comfort and durability.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-black mb-2">Modern Design</h3>
            <p className="text-gray-600">
              Contemporary styles that seamlessly blend classic elegance with modern trends.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Exceptional value without compromising on quality or craftsmanship.
            </p>
          </div>
        </div>
      </section>
